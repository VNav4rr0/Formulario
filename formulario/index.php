...
<html lang="pt-br">
  ...
  <body class="bg-secondary">
    <div class="container px-2 bg-light">
      ...
      <form method="POST" action="DadoR.class.php">
        <div class="row">
        ...
        <div class="row">
          ...
          <input type="tel" class="form-control" placeholder="(xx)xxxxx-xxxx" name="tel" id="tel"/>
        </div>
        ...
        <div class="row">
          ...
          <input type="date" class="form-control" placeholder="(xx)xxxxx-xxxx" id="date" name="date"/>
        </div>
        <div class="row">
